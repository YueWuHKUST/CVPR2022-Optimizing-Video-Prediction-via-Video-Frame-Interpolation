...
## Load GT images
middleburry_root = "/disk1/yue/data/videopred/middlebury/other-data/"
video = []
...
#my_root = "/disk1/yue/code/iclr2022-prediction/baselines/deep-voxel-flow/middlebury_result/"
#my_root = "/disk1/yue/code/iclr2022-prediction/baselines/DYAN/DYAN_results/result_middlebury_ucfweights_pyflow/"
# my_root = '/disk1/yue/code/iclr2022-prediction/internal_learning/result_middlebury_sintel_repeat/'
my_root = '/disk1/yue/code/iclr2022-prediction/internal_learning/result_middlebury_sintel/'
# my_root = "../cvpr2022_OMP_results/result_middlebury/"
my_videos = []
for i in range(num_vids):
	#sub_dir = my_root + "%04d/"%i
	sub_dir = my_root + "%s/"%scene_dir[i] + "/"
	images = []
